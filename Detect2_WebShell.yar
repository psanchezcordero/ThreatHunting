    ...
    Este conjunto de reglas de Yara está bajo la licencia GNU-GPLv2 (http://www.gnu.org/licenses/gpl-2.0.html) y está abierto a cualquier usuario u organización, siempre que lo use bajo esta licencia.

* /

importar "pe"

regla Weevely_Webshell {
	meta:
		description = "Shell web semanal - Regla genérica - shell web minúsculo muy codificado"
		autor = "Florian Roth"
		referencia = "http://www.ehacking.net/2014/12/weevely-php-stealth-web-backdoor-kali.html"
		fecha = "2014/12/14"
		puntuación = 60
	instrumentos de cuerda:
		$ php = "<? php" ascii
		$ s0 = / \ $ [az] {4} = \ $ [az] {4} \ ("[az] [az]?", [\ s]? "", [\ s]? "/ ascii
		$ s1 = / \ $ [az] {4} = str_replace \ ("[az] [az]?", "", "/ ascii
		$ s2 = / \ $ [az] {4} \. \ $ [az] {4} \. \ $ [az] {4} \. \ $ [az] {4} \) \) \); \ $ [az] {4} \ (\); / ascii
		$ s4 = / \ $ [az] {4} = "[a-zA-Z0-9] {70} / ascii
	condición:
		$ php en 0 y todo ($ s *) y tamaño de archivo> 570 y tamaño de archivo <800
}

regla webshell_h4ntu_shell_powered_by_tsoi_ {
	meta:
		descripción = "Web Shell - archivo h4ntu shell [desarrollado por tsoi] .php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "06ed0b2398f8096f1bebf092d0526137"
	instrumentos de cuerda:
		$ s0 = "<TD> <DIV STYLE = \" font-family: verdana; tamaño de fuente: 10px; \ "> <b> Dirección del servidor: </ b"
		$ s3 = "<TD> <DIV STYLE = \" font-family: verdana; tamaño de fuente: 10px; \ "> <b> Información del usuario: </b> ui"
		$ s4 = "<TD> <DIV STYLE = \" font-family: verdana; font-size: 10px; \ "> <? = $ info?>: <? ="
		$ s5 = "<TIPO DE ENTRADA = \" text \ "NAME = \" cmd \ "value = \" <? php echo stripslashes (htmlentities ($ "
	condición:
		todos ellos
}
regla webshell_PHP_sql {
	meta:
		descripción = "Web Shell - archivo sql.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "2cf20a207695bbc2311a998d1d795c35"
	instrumentos de cuerda:
		$ s0 = "$ result = mysql_list_tables ($ db) o die (\" $ h_error <b> \ ". mysql_error (). \" </b> $ f_ "
		$ s4 = "print \" <a href = \\\ "$ _ SERVER [PHP_SELF]? s = $ s & login = $ login & passwd = $ passwd &"
	condición:
		todos ellos
}
regla webshell_PHP_a {
	meta:
		descripción = "Web Shell - archivo a.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "e3b461f7464d81f5022419d87315a90d"
	instrumentos de cuerda:
		$ s1 = "echo \" <valor de opción = \\\ "\". strrev (substr (strstr (strrev ($ work_dir)), \ "/ \" "
		$ s2 = "echo \" <option value = \\\ "$ work_dir \\\" selected> Current Directory </option> "
		$ s4 = "<input name = \" submit_btn \ "type = \" submit \ "value = \" Ejecutar comando \ "> </p>" palabra completa
	condición:
		2 de ellos
}
regla webshell_iMHaPFtp_2 {
	meta:
		descripción = "Web Shell - archivo iMHaPFtp.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "12911b73bc6a5d313b494102abcf5c57"
	instrumentos de cuerda:
		$ s8 = "if ($ l) echo '<a href = \"'. $ self. '? action = permission & amp; file ='. urlencode ($ "
		$ s9 = "return base64_decode ('R0lGODlhEQANAJEDAMwAAP /// 5mZmf /// yH5BAHoAwMALAAAAAARAA0AAA"
	condición:
		1 de ellos
}
regla webshell_Jspspyweb {
	meta:
		description = "Web Shell - archivo Jspspyweb.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_Safe_Mode_Bypass_PHP_4_4_2_and_PHP_5_1_2 {
	meta:
		description = "Web Shell - archivo Safe_Mode Bypass PHP 4.4.2 y PHP 5.1.2.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "49ad9117c96419c35987aaa7e2230f63"
	instrumentos de cuerda:
		$ s0 = "morir (\" \\ nBienvenido .. Con este script puede saltar en el (Modo seguro = ON) .. Disfrute \\ n "
		$ s1 = "Modo Shell v1.0 </font> </span> </a> </font> <font face = \" Webdings \ "size = \" 6 \ "color"
	condición:
		1 de ellos
}
regla webshell_SimAttacker_Vrsion_1_0_0_priv8_4_My_friend {
	meta:
		description = "Web Shell - archivo SimAttacker - Vrsion 1.0.0 - priv8 4 My friend.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
	...
	instrumentos de cuerda:
		...
		$ s3 = "fputs ($ fp, \" \\ n ************************************ ********* \\ nBienvenido T0 Sim "
	condición:
		1 de ellos
}
regla webshell_phpshell_2_1_pwhash {
	meta:
		descripción = "Web Shell - archivo pwhash.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "ba120abac165a5a30044428fac1970d8"
	instrumentos de cuerda:
		$ s1 = "<tt> & nbsp; </tt> \" (espacio), \ "<tt> [</tt> \" (soporte izquierdo), \ "<tt> | </tt> \" (pi "
		$ s3 = "palabra: \" <tt> nulo </tt> \ ", \" <tt> sí </tt> \ ", \" <tt> no </tt> \ ", \" <tt> verdadero </tt> \ ","
	condición:
		1 de ellos
}
regla webshell_PHPRemoteView {
	meta:
		description = "Web Shell - archivo PHPRemoteView.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "29420106d9a81553ef0d1ca72b9934d9"
	instrumentos de cuerda:
		$ s2 = "<input type = submit value = '\". mm (\ "Eliminar todos los directorios / archivos recursivos \"). \ "(rm -fr)'"
		$ s4 = "<a href = '$ self? c = delete & c2 = $ c2 & confirm = delete & d = \". urlencode ($ d). \ "& f = \". u "
	condición:
		1 de ellos
}
regla webshell_jsp_12302 {
	meta:
		descripción = "Web Shell - archivo 12302.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "a3930518ea57d899457a62f372205f7f"
	instrumentos de cuerda:
		$ s0 = "</font> <% out.print (request.getRealPath (request.getServletPath ()));%>" palabra completa
		$ s1 = "<% @ page import = \" java.io. *, java.util. *, java.net. * \ "%>" palabra completa
		$ s4 = "Ruta de cadena = cadena nueva (request.getParameter (\" ruta \ "). getBytes (\" ISO-8859-1 \ ""
	condición:
		todos ellos
}
regla webshell_caidao_shell_guo {
	meta:
		descripción = "Web Shell - archivo guo.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_PHP_redcod {
	meta:
		descripción = "Web Shell - archivo redcod.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "5c1c8120d82f46ff9d813fbe3354bac5"
	instrumentos de cuerda:
		$ s0 = "H8p0bGFOEy7eAly4h4E4o88LTSVHoAglJ2KLQhUw" palabra completa
		$ s1 = "HKP7dVyCf8cgnWFy8ocjrP5ffzkn9ODroM0 / raHm" palabra completa
	condición:
		todos ellos
}
regla webshell_remview_fix {
	meta:
		description = "Web Shell - archivo remview_fix.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
	...
	instrumentos de cuerda:
		$ s4 = "<a href = '$ self? c = delete & c2 = $ c2 & confirm = delete & d = \". urlencode ($ d). \ "& f = \". u "
		$ s5 = "echo \" <P> <hr size = 1 noshade> \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n \\ n "
	condición:
		1 de ellos
}
regla webshell_asp_cmd {
	meta:
		descripción = "Web Shell - archivo cmd.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "895ca846858c315a3ff8daa7c55b3119"
	instrumentos de cuerda:
		$ s0 = "<% = \" \\\\\ "& oScriptNet.ComputerName & \" \\\ "& oScriptNet.UserName%>" palabra completa
		$ s1 = "Establecer oFileSys = Server.CreateObject (\" Scripting.FileSystemObject \ ")" palabra completa
		$ s3 = "Llamar a oScript.Run (\" cmd.exe / c \ "& szCMD & \"> \ "& szTempFile, 0, True)" palabra completa
	condición:
		1 de ellos
}
regla webshell_php_sh_server {
	meta:
		descripción = "Web Shell - archivo server.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 50
		hash = "d87b019e74064aa90e2bb143e5e16cfa"
	instrumentos de cuerda:
		$ s0 = "eval (getenv ('HTTP_CODE'));" palabra completa
	condición:
		todos ellos
}
regla webshell_PH_Vayv_PH_Vayv {
	meta:
		descripción = "Web Shell - archivo PH Vayv.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "35fb37f3c806718545d97c6559abd262"
	instrumentos de cuerda:
		$ s0 = "estilo = \" COLOR DE FONDO: # eae9e9; FRONTERA INFERIOR: # 000000 1px en "
		$ s4 = "<font color = \" # 858585 \ "> SHOPEN </font> </a> </font> <font face = \" Verdana \ "style"
	condición:
		1 de ellos
}
regla webshell_caidao_shell_ice {
	meta:
		descripción = "Web Shell - archivo ice.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "6560b436d3d3bb75e2ef3f032151d139"
	instrumentos de cuerda:
		$ s0 = "<% solicitud de evaluación (\" ice \ ")%>" palabra completa
	condición:
		todos ellos
}
regla webshell_cihshell_fix {
	meta:
		description = "Web Shell - archivo cihshell_fix.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "3823ac218032549b86ee7c26f10c4cb5"
	instrumentos de cuerda:
		$ s7 = "<tr style = 'fondo: # 242424;' > <td style = 'padding: 10px;'> <form action = '' encty "
		$ s8 = "if (isset ($ _ POST ['mysqlw_host'])) {$ dbhost = $ _POST ['mysqlw_host'];} más {$ dbhos"
	condición:
		1 de ellos
}
regla webshell_asp_shell {
	meta:
		descripción = "Web Shell - archivo shell.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "e63f5a96570e1faf4c7b8ca6df750237"
	instrumentos de cuerda:
		$ s7 = "<input type = \" submit \ "name = \" Send \ "value = \" GO! \ ">" palabra completa
		$ s8 = "<TEXTAREA NAME = \" 1988 \ "ROWS = \" 18 \ "COLS = \" 78 \ "> </TEXTAREA>" palabra completa
	condición:
		todos ellos
}
regla webshell_Private_i3lue {
	meta:
		descripción = "Web Shell - archivo Private-i3lue.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "13f5c7a035ecce5f9f380967cf9d4e92"
	instrumentos de cuerda:
		$ s8 = "caso 15: $ imagen. = \" \\ 21 \\ 0 \\ "
	condición:
		todos ellos
}
regla webshell_php_up {
	meta:
		descripción = "Web Shell - archivo up.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "7edefb8bd0876c41906f4b39b52cd0ef"
	instrumentos de cuerda:
		$ s0 = "copy ($ HTTP_POST_FILES ['userfile'] ['tmp_name'], $ _POST ['remotefile']);" palabra completa
		$ s3 = "if (is_uploaded_file ($ HTTP_POST_FILES ['userfile'] ['tmp_name'])) {" palabra completa
		$ s8 = "echo \" Archivo cargado: \ ". $ HTTP_POST_FILES ['userfile'] ['name'];" palabra completa
	condición:
		2 de ellos
}
regla webshell_Mysql_interface_v1_0 {
	meta:
		descripción = "Web Shell - archivo Mysql interface v1.0.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_php_s_u {
	meta:
		descripción = "Web Shell - archivo su.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "efc7ba1a4023bcf40f5e912f1dd85b5a"
	instrumentos de cuerda:
		$ s6 = "<a href=\"?act=do\"> <font color = \" red \ "> Ir a ejecutar </font> </a> </b> <br /> <textarea"
	condición:
		todos ellos
}
regla webshell_phpshell_2_1_config {
	meta:
		descripción = "Web Shell - archivo config.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "bd83144a649c5cc21ac41b505a36a8f3"
	instrumentos de cuerda:
		$ s1 = "; (¡elija buenas contraseñas!). Agregue usos como líneas simples 'username = \" password \ "'." palabra completa
	condición:
		todos ellos
}
regla webshell_asp_EFSO_2 {
	meta:
		descripción = "Web Shell - archivo EFSO_2.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_jsp_up {
	meta:
		descripción = "Web Shell - archivo up.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "515a5dd86fe48f673b72422cccf5a585"
	instrumentos de cuerda:
		$ s9 = "// ERROR: Corta el archivo si es mayor de 640Ks" palabra completa
	condición:
		todos ellos
}
regla webshell_NetworkFileManagerPHP {
	meta:
		description = "Web Shell - archivo NetworkFileManagerPHP.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "acdbba993a5a4186fd864c5e4ea0ba4f"
	instrumentos de cuerda:
		$ s9 = "echo \" <br> <center> Todos los datos en estas tablas: <br> \ ". $ tblsv. \" se pusieron "
	condición:
		todos ellos
}
regla webshell_Server_Variables {
	meta:
		description = "Web Shell - Variables.asp del servidor de archivos"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "47fb8a647e441488b30f92b4d39003d7"
	instrumentos de cuerda:
		$ s7 = "<% para cada Vars en Request.ServerVariables%>" palabra completa
		$ s9 = "Nombre de variable </B> </font> </p>" palabra completa
	condición:
		todos ellos
}
regla webshell_caidao_shell_ice_2 {
	meta:
		descripción = "Web Shell - archivo ice.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "1d6335247f58e0a5b03e17977888f5f2"
	instrumentos de cuerda:
		$ s0 = "<? php $ {$ {eval ($ _ POST [ice])}};?>" palabra completa
	condición:
		todos ellos
}
regla webshell_caidao_shell_mdb {
	meta:
		descripción = "Web Shell - archivo mdb.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "fbf3847acef4844f3a0d04230f6b9ff9"
	instrumentos de cuerda:
		$ s1 = "<% ejecutar solicitud (\" ice \ ")%> una" palabra completa
	condición:
		todos ellos
}
regla webshell_jsp_guige {
	meta:
		descripción = "Web Shell - archivo guige.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_phpspy2010 {
	meta:
		descripción = "Web Shell - archivo phpspy2010.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
	...
	instrumentos de cuerda:
		...
		$ s5 = "// ángel" palabra completa
		$ s8 = "$ admin ['cookiedomain'] = '';" palabra completa
	condición:
		todos ellos
}
regla webshell_asp_ice {
	meta:
		descripción = "Web Shell - archivo ice.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
...
regla webshell_drag_system {
	meta:
		descripción = "Web Shell - archivo system.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "15ae237cf395fb24cf12bff141fb3f7c"
	instrumentos de cuerda:
		$ s9 = "String sql = \" SELECT * FROM DBA_TABLES WHERE TABLE_NAME no como '% $%' y num_ "
	condición:
		todos ellos
}
regla webshell_DarkBlade1_3_asp_indexx {
	meta:
		descripción = "Web Shell - archivo indexx.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "b7f46693648f534c2ca78e3f21685707"
	instrumentos de cuerda:
		$ s3 = "Const strs_toTransform = \" comando | Radmin | NTAuThenabled | FilterIp | IISSample | PageCou "
	condición:
		todos ellos
}
regla webshell_phpshell3 {
	meta:
		descripción = "Web Shell - archivo phpshell3.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
	...
	instrumentos de cuerda:
		...
		$ s5 = "<p> Nombre de usuario: <input name = \" username \ "type = \" text \ "value = \" <? php echo $ userna "
		$ s7 = "$ _SESSION ['output']. = \" cd: no se pudo cambiar a: $ new_dir \\ n \ ";" palabra completa
	condición:
		2 de ellos
}
regla webshell_jsp_hsxa {
	meta:
		descripción = "Web Shell - archivo hsxa.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "d0e05f9c9b8e0b3fa11f57d9ab800380"
	instrumentos de cuerda:
		$ s0 = "<% @ idioma de página = \" java \ "pageEncoding = \" gbk \ "%> <jsp: directive.page import = \" ja "
	condición:
		todos ellos
}
regla webshell_jsp_utils {
	meta:
		descripción = "Web Shell - archivo utils.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "9827ba2e8329075358b8e8a53e20d545"
	instrumentos de cuerda:
		$ s0 = "ResultSet r = c.getMetaData (). getTables (null, null, \"% \ ", t);" palabra completa
		$ s4 = "Cadena cs = request.getParameter (\" z0 \ ") == null? \" gbk \ ": request.getParameter (\" z "
	condición:
		todos ellos
}
regla webshell_asp_01 {
	meta:
		descripción = "Web Shell - archivo 01.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 50
		hash = "61a687b0bea0ef97224c7bd2df118b87"
	instrumentos de cuerda:
		$ s0 = "<% solicitud de evaluación (\" pass \ ")%>" palabra completa
	condición:
		todos ellos
}
regla webshell_asp_404 {
	meta:
		descripción = "Web Shell - archivo 404.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_webshell_cnseay02_1 {
	meta:
		descripción = "Web Shell - archivo webshell-cnseay02-1.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "95fc76081a42c4f26912826cb1bd24b1"
	instrumentos de cuerda:
		$ s0 = "(93). $ _ uU (41). $ _ uU (59); $ _ fF = $ _ uU (99). $ _ uU (114). $ _ uU (101). $ _ uU (97). $ _ uU (97) 116). $ _ UU "
	condición:
		todos ellos
}
regla webshell_php_fbi {
	meta:
		descripción = "Web Shell - archivo fbi.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_B374kPHP_B374k {
	meta:
		description = "Web Shell - archivo B374k.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "bed7388976f8f1d90422e8795dff1ea6"
	instrumentos de cuerda:
		$ s0 = "Http://code.google.com/p/b374k-shell" palabra completa
		$ s1 = "$ _ = str_rot13 ('tm'. 'vas'. 'yngr'); $ _ = str_rot13 (strrev ('rqb'. 'prq' .'_ '.' 46r '.' fno '"
		$ s3 = "Jayalah Indonesiaku y Lyke @ 2013" palabra completa
		$ s4 = "B374k Vip In Embellecer solo para sí mismo" palabra completa
	condición:
		1 de ellos
}
regla webshell_cmd_asp_5_1 {
	meta:
		descripción = "Web Shell - archivo cmd-asp-5.1.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "8baa99666bf3734cbdfdd10088e0cd9f"
	instrumentos de cuerda:
		$ s9 = "Llamar a OS Run (\" win.com cmd.exe / c \ "\" \ "& szCMD & \"> \ "& szTF &" palabra completa
	condición:
		todos ellos
}
regla webshell_php_dodo_zip {
	meta:
		descripción = "Web Shell - archivo zip.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_aZRaiLPhp_v1_0 {
	meta:
		description = "Web Shell - archivo aZRaiLPhp v1.0.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_php_list {
	meta:
		descripción = "Web Shell - archivo list.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "922b128ddd90e1dc2f73088956c548ed"
	instrumentos de cuerda:
		$ s1 = "// list.php = Directorio y listado de archivos" palabra completa
		$ s2 = "echo \" () <a href=?file=\". $fichero. \"/\". $filename. \"> \ ". $ filena"
		$ s9 = "// por: The Dark Raver" palabra completa
	condición:
		1 de ellos
}
regla webshell_ironshell {
	meta:
		description = "Web Shell - archivo ironshell.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_caidao_shell_404 {
	meta:
		descripción = "Web Shell - archivo 404.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "ee94952dc53d9a29bdf4ece54c7a7aa7"
	instrumentos de cuerda:
		$ s0 = "<? php $ K = sTr_RepLaCe ('`', '', 'a`s`s`e`r`t'); $ M = $ _ POST [ice]; IF ($ M == NuLl ) HEADR ('St "
	condición:
		todos ellos
}
regla webshell_ASP_aspydrv {
	meta:
		descripción = "Web Shell - archivo aspydrv.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_jsp_web {
	meta:
		descripción = "Web Shell - archivo web.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_mysqlwebsh {
	meta:
		descripción = "Web Shell - archivo mysqlwebsh.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_jspShell {
	meta:
		descripción = "Web Shell - archivo jspShell.jsp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_Dx_Dx {
	meta:
		descripción = "Web Shell - archivo Dx.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "9cfe372d49fe8bf2fac8e1c534153d9b"
	instrumentos de cuerda:
		$ s1 = "print \" \\ n \ ". 'Consejo: para ver el archivo \" como está \ "- abra la página en <a href = \"'. Dx "
		$ s9 = "class = linelisting> <nobr> POST (php eval) </td> <"
	condición:
		1 de ellos
}
regla webshell_asp_ntdaddy {
	meta:
		descripción = "Web Shell - archivo ntdaddy.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "c5e6baa5d140f73b4e16a6cfde671c68"
	instrumentos de cuerda:
		$ s9 = "if FP = \" RefreshFolder \ "o"
		$ s10 = "request.form (\" cmdOption \ ") = \" DeleteFolder \ ""
	condición:
		1 de ellos
}
regla webshell_MySQL_Web_Interface_Version_0_8 {
	meta:
		description = "Web Shell - archivo MySQL Web Interface Versión 0.8.php"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
...
regla webshell_elmaliseker_2 {
	meta:
		descripción = "Web Shell - archivo elmaliseker.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
		hash = "b32d1730d23a660fd6aa8e60c3dc549f"
	instrumentos de cuerda:
		$ s1 = "<td <% if (FSO.GetExtensionName (ruta & \" \\\ "& oFile.Name) = \" lnk \ ") o (FSO.GetEx"
		$ s6 = "<input type = button value = Save onclick = \" EditorCommand ('Save') \ "> <input type = but"
	condición:
		todos ellos
}
regla webshell_ASP_RemExp {
	meta:
		descripción = "Web Shell - archivo RemExp.asp"
		autor = "Florian Roth"
		date = "2014/01/28"
		puntuación = 70
